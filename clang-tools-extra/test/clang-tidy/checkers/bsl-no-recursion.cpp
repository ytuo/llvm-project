// RUN: %check_clang_tidy -std=c++17-or-later %s bsl-no-recursion %t
// RUN: %check_clang_tidy -std=c++11,c++14 -check-suffix=,CXX11-14 %s bsl-no-recursion %t -- -- -DCXX11-14 
...
// CHECK-NOTES: :[[@LINE-4]]:6: warning: function 'endless_recursion' is within a recursive call chain [bsl-no-recursion]
...
// CHECK-NOTES: :[[@LINE-5]]:6: warning: function 'maybe_endless_recursion' is within a recursive call chain [bsl-no-recursion]
...
// CHECK-NOTES: :[[@LINE-6]]:6: warning: function 'recursive_countdown' is within a recursive call chain [bsl-no-recursion]
...
// CHECK-NOTES: :[[@LINE-9]]:6: warning: function 'conditionally_executed' is within a recursive call chain [bsl-no-recursion]
...
// CHECK-NOTES: :[[@LINE-10]]:6: warning: function 'indirect_recursion' is within a recursive call chain [bsl-no-recursion]
...
// CHECK-NOTES: :[[@LINE-8]]:6: warning: function 'maybe_selfrecursion_with_two_backedges' is within a recursive call chain [bsl-no-recursion]
...
// CHECK-NOTES: :[[@LINE-15]]:6: warning: function 'conditionally_executed_choice_0' is within a recursive call chain [bsl-no-recursion]
...
// CHECK-NOTES: :[[@LINE-16]]:6: warning: function 'conditionally_executed_choice_1' is within a recursive call chain [bsl-no-recursion]
// CHECK-NOTES: :[[@LINE-13]]:6: warning: function 'indirect_recursion_with_alternatives' is within a recursive call chain [bsl-no-recursion]
...
// CHECK-NOTES: :[[@LINE-13]]:13: warning: function 'conditionally_executed_depth1' is within a recursive call chain [bsl-no-recursion]
...
// CHECK-NOTES: :[[@LINE-15]]:13: warning: function 'conditionally_executed_depth0' is within a recursive call chain [bsl-no-recursion]
// CHECK-NOTES: :[[@LINE-12]]:6: warning: function 'indirect_recursion_with_depth2' is within a recursive call chain [bsl-no-recursion]
...
// CHECK-NOTES: :[[@LINE-9]]:6: warning: function 'bar' is within a recursive call chain [bsl-no-recursion]
...
// CHECK-NOTES: :[[@LINE-10]]:5: warning: function 'boo' is within a recursive call chain [bsl-no-recursion]
...
// CHECK-NOTES: :[[@LINE-9]]:5: warning: function 'recursion_through_lambda' is within a recursive call chain [bsl-no-recursion]
// CHECK-NOTES-CXX11-14: :[[@LINE-9]]:13: note: example recursive call chain, starting from function 'operator()'
// CHECK-NOTES-CXX11-14: :[[@LINE-8]]:14: note: Frame #1: function 'operator()' calls function 'recursion_through_lambda' here:
// CHECK-NOTES-CXX11-14: :[[@LINE-6]]:10: note: Frame #2: function 'recursion_through_lambda' calls function 'operator()' here:
// CHECK-NOTES-CXX11-14: :[[@LINE-7]]:10: note: ... which was the starting point of the recursive call chain; there may be other cycles
// CHECK-NOTES-CXX11-14: :[[@LINE-13]]:13: warning: function 'operator()' is within a recursive call chain [bsl-no-recursion]
